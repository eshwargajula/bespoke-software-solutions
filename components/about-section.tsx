          ...
          >
            ...
            <div className="space-y-3 sm:space-y-4 text-slate-600 dark:text-slate-300">
              <p className="text-sm sm:text-base lg:text-lg leading-relaxed">
                Founded with a mission to revolutionize healthcare technology and startup innovation, Bespoke Software Solutions
                has been at the forefront of digital transformation since 2019. We understand the unique challenges
